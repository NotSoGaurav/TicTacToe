...
> **A "Fundamentals of AI & ML" Project | Gaurav Tiwari**
...
1.  **Evaluation:** The AI looks at the board and assigns a score (+10 for an AI win, -10 for a Human win).
2.  **Minimaxing:** It recursively simulates every possible game outcome to **Maximize** its own score while **Minimizing** yours.
3.  **Recursion:** It plays thousands of "mental games" before making a single move on your screen!
...
cd TicTacToe
Gemini said
Here is the complete, single-block Markdown code for your README.md. I’ve ensured all instances of "Abhinav" are replaced with Gaurav and the GitHub handle is updated to NotSoGaurav.
